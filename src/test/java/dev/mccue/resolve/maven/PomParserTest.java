...
public final class PomParserTest {
        ...
        public void parseBasicPOM() throws SAXException {
                ...
                try {
                        var project = PomParser.parsePom(repository
                                        .getPom(new Dependency("dev.mccue", "resolve", "0.0.1")));
                        ...
                        assertEquals(Map.of("junit.version.two", "5.9", "junit.version.one",
                                        "5.9.0", "pomInfo.build.sourceEncoding", "UTF-8"),
                                        project.properties());
        ...
        public void variableReplacementTest() throws SAXException {
                ...
                try {
                        var project = PomParser.parsePom(repository
                                        .getPom(new Dependency("dev.mccue", "resolve", "0.0.2")));
                        assertEquals(new GroupId("dev.mccue"), project.module().groupId());
                        assertEquals(new ArtifactId("resolve"), project.module().artifactId());
