...
public class DependencyGraph {
    private Map<DependencyVertex, List<DependencyVertex>> deps = new HashMap<>();
    ...
    void removeSubDependency(DependencyVertex subDep) {
        deps.values().removeAll(Collections.singleton(subDep));
    }

    /**
     * This method returns a boolean indicating whether or not the provided
     ...
     */
    public int hasInterdependency(DependencyVertex dep1, DependencyVertex dep2) {
    ...
    public String toString() {
        ...
        for(DependencyVertex  v: deps.keySet()) {
            builder.append(v.toString() + " \033[1;37m" + "requires" + "\033[0m { ");
...
class DependencyVertex {
    ...
    DependencyVertex(String name, String groupID, String version) {
        this.name = name;
    ...
    @Override
    public String toString() {
        return "[NAME: " + this.name + " GROUPID: " + this.groupID + " VERSION: " + this.version + "]";
    }
}
